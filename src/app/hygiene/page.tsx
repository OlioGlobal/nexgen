...
const hygieneCategories: CategoryConfig[] = [
  {
    ...
    brochureHref: "/brochures/automated-hygiene-systems.pdf",
  },
  {
    label: "Manual Hygiene Systems",
    brochureHref: "/brochures/manual-hygiene-systems.pdf",
  },
  {
    label: "Single-Unit Hygiene Systems",
    brochureHref: "/brochures/single-unit-hygiene-systems.pdf",
  },
];
...
const industries: Industry[] = [
  {
    name: "Food & Beverage",
    description:
      "Enforce entry hygiene across processing zones handling raw materials, packaging, and ready-to-eat production.",
  ...
  },
  {
    name: "Biotechnology",
    description:
      "Sterile entry enforcement for labs, culture rooms, and bio-processing facilities with audit-ready logging.",
  ...
  },
  {
    name: "Electronics",
    description:
      "Particle-free entry to cleanrooms and assembly zones with air showers and sole-cleaning stations.",
    image: "/Equipment/1942 6.webp",
  },
  {
    name: "Clean Manufacturing",
    description:
      "Standardized hygiene enforcement across high-precision manufacturing and assembly environments.",
    image: "/dairy.webp",
  },
  {
    name: "Export Facilities",
    description:
      "Audit-ready hygiene infrastructure meeting BRC, FSSC 22000, SQF, and international export standards.",
